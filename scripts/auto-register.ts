...
const REGISTRY_DEPENDENCIES: Record<string, string> = {
  ...
  '@/components/ui/blur-in-text':
    'https://blocks.mvp-subha.me/r/blur-in-text.json',
  ...
  '@/components/ui/coming-soon':
    'https://blocks.mvp-subha.me/r/coming-soon.json',
  ...
  '@/components/ui/copy-button':
    'https://blocks.mvp-subha.me/r/copy-button.json',
  ...
  '@/components/ui/LegalHeader':
    'https://blocks.mvp-subha.me/r/LegalHeader.json',
  ...
  '@/components/ui/scroll-reveal-text':
    'https://blocks.mvp-subha.me/r/scroll-reveal-text.json',
  '@/components/ui/scrollbasedvelocity':
    'https://blocks.mvp-subha.me/r/scrollbasedvelocity.json',
  '@/components/ui/ScrollToTop':
    'https://blocks.mvp-subha.me/r/ScrollToTop.json',
  ...
  '@/components/ui/shiny-text': 'https://blocks.mvp-subha.me/r/shiny-text.json',
  '@/components/ui/shuffle-text':
    'https://blocks.mvp-subha.me/r/shuffle-text.json',
  ...
  '@/components/ui/target-cursor':
    'https://blocks.mvp-subha.me/r/target-cursor.json',
  '@/components/ui/text-reveal':
  ...
  '@/components/ui/variable-proximity-text':
    'https://blocks.mvp-subha.me/r/variable-proximity-text.json',
  '@/components/ui/wave-text': 'https://blocks.mvp-subha.me/r/wave-text.json',
  ...
  '@/lib/jsonld': 'https://blocks.mvp-subha.me/r/jsonld.json',
